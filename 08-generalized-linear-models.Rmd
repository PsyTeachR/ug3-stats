...
```{r logit-app, echo=FALSE, fig.cap="**Logistic regression web app** <http://shiny.psy.gla.ac.uk/Dale/logit>"}
knitr::include_app("http://shiny.psy.gla.ac.uk/Dale/logit", "500px")
```
